                ...
                <div className="relativew-full max-w-md max-h-full ">
                    ...
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div className="px-6 py-6 lg:px-8">
                            <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">Domain Edit</h3>
                            <form className="space-y-6" action="#">
                                <div>
                                    <label htmlFor="domain-name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Domain</label>
                                ...
                                <div>
                                    <label htmlFor="active-date" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Active Date</label>
